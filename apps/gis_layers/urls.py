...
from .views import (
    StateViewSet, DistrictViewSet, TalukViewSet, VillageViewSet,
    RevenueMapViewSet, HeatmapView, BoundaryImportJobViewSet,
)
...
router.register('boundary-imports', BoundaryImportJobViewSet, basename='boundary-import')
